...
<script type="text/javascript">
	...
	function changeImageCode(image){
	...
	window.onload=function(){
		...
		username.onblur=function(){
			...
			//open方法设置请求头
			//xmlhttp.open("POST","${pageContext.request.contextPath}/user/user_checkUsername");
			xmlhttp.open("GET","${pageContext.request.contextPath}/user/user_checkUsername?username="+value);
			
			
			//send方法设置参数并发送
			/*xmlhttp.send("content-type","application/x-www-form-urlencoded");
		...
		<div class="span24">
			<div class="wrap">
				<div class="main clearfix">
					...
					<form id="registerForm" action="${pageContext.request.contextPath}/user/user_register" onsubmit="return checkForm();"  method="post" novalidate="novalidate">
						<table>
							<tbody><tr>
								<th>
								...
								<td>
									...
									<span id="checkUsername" class="requiredField"></span>
							...
							<tr>
								...
								<td>
									<input type="text" id="email" name="phone" class="text" maxlength="200">
								</td>
							</tr>
									<tr>
										<th>
								...
								<tr>
									...
									<td>
										<span class="fieldSet">
											<input type="text" id="captcha" name="imageCode" class="text captcha" maxlength="4" autocomplete="off"><img id="captchaImage" class="captchaImage" src="${pageContext.request.contextPath}/user/user_generateCheckImage" onclick="changeImageCode(this)" alt="点击换一张" title="点击更换验证码">
											<s:fielderror fieldName="imageCode" theme="simple"/>
										</span>
									</td>
								</tr>
							<tr>
