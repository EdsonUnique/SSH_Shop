...
<div class="container cart">
		...
		<div class="span24">
			...
			<div class="step step1">
				...
				<div class="total">
					<em id="promotion"></em>
					商品金额: <strong id="effectivePrice">￥${order.totalprice }元</strong>
				</div>
			<form id="orderForm" action="${pageContext.request.contextPath }/order/order_payOrder" method="post">
				<input type="hidden" name="order.id" value="${order.id }"/>
				<div class="span24">
					<p>
							收货地址：<input name="order.user.addr" type="text" value="${order.address }" style="width:350px" />
								<br />
							收货人&nbsp;&nbsp;&nbsp;：<input name="order.user.username" type="text" value="${order.user.username }" style="width:150px" />
								<br /> 
